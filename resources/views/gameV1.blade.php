...
<div class="panel-body game" style="padding-top: 10px; padding-bottom: 20px;" game-tab="chanle2">
   ...
   <div class="text-left"> - Tiền thắng sẽ = <b>Tiền cược*{{ $setting->ratioCL2 }}</b><br> <b style="color:red">- Lưu ý :</b> Mức cược mỗi số khác nhau, nếu chuyển sai hạn mức hoặc sai nội dung sẽ không được hoàn tiền.<br>- Đặc biệt: bạn có <b style="color:blue">10%</b> cơ hội được trả thưởng 2 lần <img src="/upload/hot.gif" width="35px">
  </div>
</div>
<div class="panel-body game" style="padding-top: 10px; padding-bottom: 20px;" game-tab="chanle">
    ...
    <div class="text-left"> - Tiền thắng sẽ = <b>Tiền cược*{{ $setting->ratioCL }}</b><br> <b style="color:red">- Lưu ý :</b> Mức cược mỗi số khác nhau, nếu chuyển sai hạn mức hoặc sai nội dung sẽ không được hoàn tiền.<br>- Đặc biệt: bạn có <b style="color:blue">10%</b> cơ hội được trả thưởng 2 lần <img src="/upload/hot.gif" width="35px">
  </div>
</div>
<div class="panel-body game" style="padding-top: 10px; padding-bottom: 20px;" game-tab="taixiu2">
    ...
    <div class="text-left"> - Tiền thắng sẽ = <b>Tiền cược*{{ $setting->ratioTX2 }}</b><br> <b style="color:red">- Lưu ý :</b> Mức cược mỗi số khác nhau, nếu chuyển sai hạn mức hoặc sai nội dung sẽ không được hoàn tiền.<br>- Đặc biệt: bạn có <b style="color:blue">10%</b> cơ hội được trả thưởng 2 lần <img src="/upload/hot.gif" width="35px">
  </div>
</div>
<div class="panel-body game" style="padding-top: 10px; padding-bottom: 20px;" game-tab="taixiu">
    ...
    <div class="text-left"> - Tiền thắng sẽ = <b>Tiền cược*{{ $setting->ratioTX }}</b><br> <b style="color:red">- Lưu ý :</b> Mức cược mỗi số khác nhau, nếu chuyển sai hạn mức hoặc sai nội dung sẽ không được hoàn tiền.<br>- Đặc biệt: bạn có <b style="color:blue">10%</b> cơ hội được trả thưởng 2 lần <img src="/upload/hot.gif" width="35px">
  </div>
</div>
<div class="panel-body game" style="padding-top: 10px; padding-bottom: 20px;" game-tab="x3">
    ...
    <p class="mt-3">
        ...
        <span class="fa-stack"><span class="fa fa-circle fa-stack-2x dot-text-tai"> </span><span
                class="fa-stack-1x text-white comment-n3">{{ explode('|', $setting->content1P3)[3] }}</span></span></span> (nếu đuôi mã giao dịch có các số sau)
    </p>
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover text-center">
            <thead>
    ...
    <b style="color:red">- Lưu ý :</b> Mức cược mỗi số khác nhau, nếu chuyển sai hạn mức hoặc sai nội dung sẽ không được hoàn tiền.<br>- Đặc biệt: bạn có <b style="color:blue">10%</b> cơ hội được trả thưởng 2 lần <img src="/upload/hot.gif" width="35px">
  </div>
</div>
...
<div class="panel-body game" style="padding-top: 10px; padding-bottom: 20px;" game-tab="gap3">
    ...
    <b>- Lưu ý : Mức cược mỗi số khác nhau, nếu chuyển sai hạn mức hoặc sai nội dung vui lòng "liên hệ ADMIN" để được xử lí</b>
</div>
