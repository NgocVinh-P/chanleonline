                           ...
                           <table id="kt_datatable_zero_configuration" class="table table-row-bordered gy-5">
                                ...
                                @foreach($UserTopWeek as $row)
                                    <tr>
                                        ...
                                        <td class="fw-semibold fs-sm">{{ number_format($row['amountWin']) }} VND</td>
                                        <td class="fw-semibold fs-sm">{{ number_format($row['amountAll']-$row['amountWin']) }} VND</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
