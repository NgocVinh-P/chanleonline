...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link" href="{{ route('admin.historyHu') }}">
                                                ...
                                                <span class="menu-title">Lịch sử nổ hũ</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->
        ...
        <a href="https://t.me/spmsvvn" target="_blank" class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="Hỗ trợ 24/7 qua telegram">
