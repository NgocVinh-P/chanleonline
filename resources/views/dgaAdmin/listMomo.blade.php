                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-rounded mt-3">
                        ...
                        <div class="card-body block-content-full">
                            ...
                            <table id="showdata" class="table table-row-bordered gy-5">
                                <thead>
                                ...
                                <tbody>
                                    @foreach ($GetAccountMomo as $row)
                                        <tr id="td_{{ $row->id }}">
                                            ...
                                            <td class="text-gray-600 fw-semibold">{{ $row->phone }}</td>
                                            <td class="text-gray-600 fw-semibold">{{ number_format($row->balance) }} VND
                                            </td>
                                            <td class="text-gray-600 fw-semibold">{{ number_format($row->times) }}</td>
                                            <td class="text-gray-600 fw-semibold">{{ number_format($row->amount) }}</td>
                                            <td class="text-gray-600 fw-semibold">{{ number_format($row->amountMonth) }}
                                            </td>
                                            <td>
                                                {!! $row->status_text !!}
                                            </td>
